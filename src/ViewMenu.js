  ...
  return (
    <div className="container">
      <div className="row mt-5">
        <ViewAllPizzas setCartItems={setCartItems} toppings={toppings} meat={meat} setMeat={setMeat} setToppings={setToppings} price={price} setPrice={setPrice} />
        <Cart cartItems={cartItems} setCartItems={setCartItems} meat={meat} setMeat={setMeat} toppings={toppings} setToppings={setToppings} price={price} setPrice={setPrice} />
      </div>
    </div>
  );
};
...
export function ViewAllPizzas({ cartItems, setCartItems, meat, setMeat, toppings, setToppings, price, setPrice }) {
      ...
      <div className="row col-12 mt-5">
        {
          pizzaList.map((pizza, index) => (
            <ViewPizza pizza={pizza} cartItems={cartItems} setCartItems={setCartItems} key={index} meat={meat} setMeat={setMeat} toppings={toppings} setToppings={setToppings} price={price} setPrice={setPrice} />
          ))
        }
      </div>
    </div >
    ...
    <div className="col-md-4 mt-3">
      <div className="card h-100">
        ...
        <div className="card-body">
          ...
          <p className="card-text desc">{pizza.description}         </p>
          <p className="card-text">Price : {pizza.price} rs        </p>
...
const Cart = ({ cartItems, setCartItems, toppings, meat, setMeat, setToppings, price, setPrice }) => {
    ...
    <div className="col-md-4">
      <div className="row col-md-12 mt-5">
        <div className="card w-100">
          ...
          {cartItems.name && <CustomPizza setCartItems={setCartItems} cartItems={cartItems} toppings={toppings} meat={meat} setMeat={setMeat} setToppings={setToppings} price={price} setPrice={setPrice} />}
...
function CustomPizza({ cartItems, setCartItems, meat, setMeat, toppings, setToppings, price, setPrice }) {
  ...
  return (
    <div>
      ...
      {price !== 0 && <p>Aditional charges : {price}</p>}

      <p>Cart Total : {price + cartItems.price}</p>

...
export default function OrdersTracker() {
    ...
    return (
        <div className="table-responsive">
            <table className="table table-bordered table-hover w-75 mx-auto mt-5">
        ...
        <tr>
            ...
            <td>
                {!isEditable ?
                    ...
                    <button className="btn btn-warning  my-auto px-3 w-75" onClick={updateOrder}>Update</button>}</td>
        </tr>
    );
};
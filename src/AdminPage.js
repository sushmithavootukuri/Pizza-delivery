    ...
    return (
        <div>
            <div className="mx-auto">
                <button className="btn-warning d-inline m-3" onClick={() => { setViewIngredients(true); setViewOrders(false) }}>Ingredients Tracker</button>
                <button className="btn-warning d-inline m-3" onClick={() => { setViewOrders(true); setViewIngredients(false) }
